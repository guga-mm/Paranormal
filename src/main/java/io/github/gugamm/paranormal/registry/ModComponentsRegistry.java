...
public class ModComponentsRegistry {
	public static final ComponentType<Boolean> RITUAL_LEARNED = Registry.register(
		Registries.DATA_COMPONENT_TYPE,
		Identifier.of(Paranormal.MODID, "ritual_learned"),
		ComponentType.<Boolean>builder().codec(Codec.BOOL).build()
	);

	public static final ComponentType<CurseComponent> CURSE = Registry.register(
		Registries.DATA_COMPONENT_TYPE,
		Identifier.of(Paranormal.MODID, "curse"),
		ComponentType.<CurseComponent>builder().codec(CurseComponent.CODEC).build()
	);

	public static final ComponentType<List<CurseComponent>> ITEM_CURSES = Registry.register(
		Registries.DATA_COMPONENT_TYPE,
		Identifier.of(Paranormal.MODID, "item_curses"),
		ComponentType.<List<CurseComponent>>builder().codec(Codec.list(CurseComponent.CODEC)).build()
	);
